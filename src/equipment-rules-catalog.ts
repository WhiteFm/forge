...
const templateSpecs: TemplateSpec[] = [
  ...
  { key: "weapon", name: tr("Weapon", "Оружие", "Vapen"), category: "template_weapons", fields: ["weapon_tags", "weapon_mastery", "attack_ability", "finesse_attack_ability", "attack_bonus", "damage_bonus", "primary_damage", "additional_damage", "versatile_damage", "conditional_damage", "weapon_hands", "weapon_range", "weapon_reach", "ammunition_rules", "attack_targets", "attack_area", "critical_rules", "returning_thrown", "extra_damage_limit", "curse", "curse_effects"], defaultTags: ["weapon"] },
