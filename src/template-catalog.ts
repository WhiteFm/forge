...
const seeds: Record<EntityType, FieldSeed[]> = {
  ...
  item: [
    ...
    { key: "item_cost_cp", name: text("Cost, cp", "Стоимость, мм", "Kostnad, cp"), category: "economy_currency", type: "integer", minimum: 0 },
...
const optionGroupByKey: Record<string, string> = {
  ...
  item_category: "item_category", item_rarity: "rarity", item_equipment_slot: "equipment_slot", item_weapon_category: "weapon_category", item_weapon_range_type: "weapon_range_type", item_damage_type: "damage_type", item_weapon_properties: "weapon_property", item_weapon_mastery: "weapon_mastery", item_armor_category: "armor_category", item_dexterity_to_ac: "dexterity_to_ac",
