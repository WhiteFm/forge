...
const labels = {
  en: {
    ...
    cleanIntro: "A clean editable Forge project with the SRD 5.2.1 item catalog. Classes, species, spells and other character content remain empty.",
  ...
  ru: {
    ...
    cleanIntro: "Чистый редактируемый проект Кузницы с каталогом предметов SRD 5.2.1. Классы, виды, заклинания и другой контент персонажей остаются пустыми.",
  ...
  sv: {
    ...
    cleanIntro: "Ett rent redigerbart Forge-projekt med SRD 5.2.1-föremålskatalogen. Klasser, arter, besvärjelser och annat karaktärsinnehåll förblir tomt.",
