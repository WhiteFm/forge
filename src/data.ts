...
export function createEntity(entityType: EntityType, number: number): ForgeEntity {
  ...
  if (entityType === "species") return { ...common, creatureTypeId: "creature-type.humanoid", lifespanYears: 80, sizeOptions: ["size.medium"], baseSpeeds: { walk: 30 }, featureIds: [], choices: [] };
  if (entityType === "background") return { ...common, abilityOptions: ["str", "dex", "con"], abilityScoreIncrease: { allowedAbilities: ["str", "dex", "con"], distributions: [[2, 1], [1, 1, 1]], maximumScore: 20 }, featId: "", featChoiceSelections: [], proficiencyGrants: [], choices: [], equipmentOptions: [{ id: "equipment.a", items: [], choiceItems: [], currencyCp: 0 }] };
